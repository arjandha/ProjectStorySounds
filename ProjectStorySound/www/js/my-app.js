...
myApp.onPageInit('whacky', function (page) {
    var whackySounds = [
      new SoundEffect( "Applause1", "Applause", "img/Whacky/Applause1.svg", "sound/Whacky/Applause1.wav" ),
      new SoundEffect( "BabyLaughing1", "Baby Laughing", "img/Whacky/BabyLaughing1.svg", "sound/Whacky/BabyLaughing1.mp3" ),
      new SoundEffect( "Belch1", "Belch", "img/Whacky/Belch1.svg", "sound/Whacky/Belch1.wav" ),
      new SoundEffect( "Burp1", "Burp", "img/Whacky/Burp1.svg", "sound/Whacky/Burp1.wav" ),
      new SoundEffect( "FemaleChuckle1", "Female Chuckle", "img/Whacky/FemaleChuckle1.svg", "sound/Whacky/FemaleChuckle1.wav" ),
      new SoundEffect( "FemaleLaugh1", "Female Laugh", "img/Whacky/FemaleLaugh1.svg", "sound/Whacky/FemaleLaugh1.mp3" ),
      new SoundEffect( "FunnyLoop1", "Funny Loop", "img/Whacky/FunnyLoop1.svg", "sound/Whacky/FunnyLoop1.wav" ),
      new SoundEffect( "GirlLaugh1", "Girl Laugh", "img/Whacky/GirlLaugh1.svg", "sound/Whacky/GirlLaugh1.wav" ),
      new SoundEffect( "Grunt1", "Grunt 1", "img/Whacky/Grunt1.svg", "sound/Whacky/Grunt1.wav" ),
      new SoundEffect( "Grunt2", "Grunt 2", "img/Whacky/Grunt2.svg", "sound/Whacky/Grunt2.wav" ),
      ...
      new SoundEffect( "PartyHorn1", "Party Horn", "img/Whacky/PartyHorn1.svg", "sound/Whacky/PartyHorn1.wav" ),
      new SoundEffect( "Plop1", "Plop", "img/Whacky/Plop1.svg", "sound/Whacky/Plop1.wav" ),
      new SoundEffect( "Sneeze1", "Sneeze", "img/Whacky/Sneeze1.svg", "sound/Whacky/Sneeze1.wav" ),
      new SoundEffect( "Snoring1", "Snoring", "img/Whacky/Snoring1.svg", "sound/Whacky/Snoring1.mp3" ),
      new SoundEffect( "Squeak1", "Squeak", "img/Whacky/Squeak1.svg", "sound/Whacky/Squeak1.wav" )
    ];
...
myApp.onPageInit('space', function (page) {
    var spaceStorySounds = [
      ...
      new SoundEffect( "Alien2", "Alien 2", "img/SpaceStory/Alien2.svg", "sound/SpaceStory/Alien2.wav" ),
      new SoundEffect( "Alien3", "Alien 3", "img/SpaceStory/Alien3.svg", "sound/SpaceStory/Alien3.wav" ),
      new SoundEffect( "Countdown1", "Countdown", "img/SpaceStory/Countdown1.svg", "sound/SpaceStory/Countdown1.wav" ),
      new SoundEffect( "DoorFuturistic1", "Door Futuristic", "img/SpaceStory/DoorFuturistic1.svg", "sound/SpaceStory/DoorFuturistic1.wav" ),
      ...
      new SoundEffect( "FlyingCar1", "Flying Car", "img/SpaceStory/FlyingCar1.svg", "sound/SpaceStory/FlyingCar1.wav" ),
      new SoundEffect( "Laser1", "Laser 1", "img/SpaceStory/Laser1.svg", "sound/SpaceStory/Laser1.mp3" ),
      new SoundEffect( "Laser2", "Laser 2", "img/SpaceStory/Laser2.svg", "sound/SpaceStory/Laser2.wav" ),
      new SoundEffect( "Launch1", "Launch", "img/SpaceStory/Launch1.svg", "sound/SpaceStory/Launch1.wav" ),
      new SoundEffect( "LaunchSequence1", "Launch Sequence", "img/SpaceStory/LaunchSequence1.svg", "sound/SpaceStory/LaunchSequence1.mp3" ),
      new SoundEffect( "Phaser1", "Phaser 1", "img/SpaceStory/Phaser1.svg", "sound/SpaceStory/Phaser1.wav" ),
      new SoundEffect( "Phaser2", "Phaser 2", "img/SpaceStory/Phaser2.svg", "sound/SpaceStory/Phaser2.wav" ),
      new SoundEffect( "PulseEcho1", "Pulse Echo", "img/SpaceStory/PulseEcho1.svg", "sound/SpaceStory/PulseEcho1.mp3" ),
      new SoundEffect( "Robot1", "Robot 1", "img/SpaceStory/Robot1.svg", "sound/SpaceStory/Robot1.wav" ),
      new SoundEffect( "Robot2", "Robot 2", "img/SpaceStory/Robot2.svg", "sound/SpaceStory/Robot2.wav" ),
      new SoundEffect( "RobotCountdown1", "Robot Countdown", "img/SpaceStory/RobotCountdown1.svg", "sound/SpaceStory/RobotCountdown1.wav" ),
      new SoundEffect( "RobotVoice1", "Robot Voice", "img/SpaceStory/RobotVoice1.svg", "sound/SpaceStory/RobotVoice1.wav" ),
      new SoundEffect( "RobotWow1", "Robot Wow", "img/SpaceStory/RobotWow1.svg", "sound/SpaceStory/RobotWow1.wav" ),
      ...
      new SoundEffect( "UFOLanding1", "U.F.O. Landing", "img/SpaceStory/UFOLanding1.svg", "sound/SpaceStory/UFOLanding1.wav" )
    ];
...
myApp.onPageInit('scary', function (page) {
    var scaryStorySounds = [
      new SoundEffect( "Cat1", "Cat", "img/ScaryStory/Cat1.svg", "sound/ScaryStory/Cat1.wav" ),
      new SoundEffect( "Circus1", "Circus", "img/ScaryStory/Circus1.svg", "sound/ScaryStory/Circus1.mp3" ),
      new SoundEffect( "Creaking1", "Creaking", "img/ScaryStory/Creaking1.svg", "sound/ScaryStory/Creaking1.flac" ),
      new SoundEffect( "CreakyDoor1", "Creaky Door", "img/ScaryStory/CreakyDoor1.svg", "sound/ScaryStory/CreakyDoor1.wav" ),
      new SoundEffect( "DogBarks1", "Dog Barks", "img/ScaryStory/DogBarks1.svg", "sound/ScaryStory/DogBarks1.mp3" ),
      new SoundEffect( "DoorClosing1", "Door Closing", "img/ScaryStory/DoorClosing1.svg", "sound/ScaryStory/DoorClosing1.wav" ),
      new SoundEffect( "EerieBackground2", "Eerie Background", "img/ScaryStory/EerieBackground2.svg", "sound/ScaryStory/EerieBackground2.wav" ),
      new SoundEffect( "EvilLaugh1", "Evil Laugh 1", "img/ScaryStory/EvilLaugh1.svg", "sound/ScaryStory/EvilLaugh1.flac" ),
      new SoundEffect( "EvilLaugh2", "Evil Laugh 2", "img/ScaryStory/EvilLaugh2.svg", "sound/ScaryStory/EvilLaugh2.wav" ),
      ...
      new SoundEffect( "GhostScream1", "Ghost Scream", "img/ScaryStory/GhostScream1.svg", "sound/ScaryStory/GhostScream1.wav" ),
      ...
      new SoundEffect( "Piano1", "Piano", "img/ScaryStory/Piano1.svg", "sound/ScaryStory/Piano1.wav" ),
      ...
      new SoundEffect( "Suspense3", "Suspense 3", "img/ScaryStory/Suspense3.svg", "sound/ScaryStory/Suspense3.wav" ),
      ...
      new SoundEffect( "TickTock1", "Tick Tock", "img/ScaryStory/TickTock1.svg", "sound/ScaryStory/TickTock1.wav" ),
      new SoundEffect( "Wind1", "Wind", "img/ScaryStory/Wind1.svg", "sound/ScaryStory/Wind1.mp3" ),
      new SoundEffect( "WitchCackle1", "Witch Cackle 1", "img/ScaryStory/WitchCackle1.svg", "sound/ScaryStory/WitchCackle1.wav" ),
      new SoundEffect( "WitchCackle2", "Witch Cackle 2", "img/ScaryStory/WitchCackle2.svg", "sound/ScaryStory/WitchCackle2.mp3" ),
      new SoundEffect( "Wolf1", "Wolf", "img/ScaryStory/Wolf1.svg", "sound/ScaryStory/Wolf1.wav" )
    ];
...
myApp.onPageInit('old', function (page) {
    var oldFashionedSounds = [
      ...
      new SoundEffect( "BikeHorn1", "Bike Horn", "img/OldFashioned/BikeHorn1.svg", "sound/OldFashioned/BikeHorn1.wav" ),
      new SoundEffect( "BoatHorn1", "Boat Horn", "img/OldFashioned/BoatHorn1.svg", "sound/OldFashioned/BoatHorn1.wav" ),
      ...
      new SoundEffect( "Dialing1", "Dialing", "img/OldFashioned/Dialing1.svg", "sound/OldFashioned/Dialing1.wav" ),
      new SoundEffect( "Doorbell1", "Doorbell", "img/OldFashioned/Doorbell1.svg", "sound/OldFashioned/Doorbell1.wav" ),
      new SoundEffect( "HorseGalloping1", "Horse Galloping", "img/OldFashioned/HorseGalloping1.svg", "sound/OldFashioned/HorseGalloping1.wav" ),
      ...
      new SoundEffect( "SchoolBell1", "School Bell", "img/OldFashioned/SchoolBell1.svg", "sound/OldFashioned/SchoolBell1.wav" ),
      new SoundEffect( "ScreenDoor1", "Screen Door", "img/OldFashioned/ScreenDoor1.svg", "sound/OldFashioned/ScreenDoor1.wav" ),
      new SoundEffect( "SubmarinePing1", "Submarine Ping", "img/OldFashioned/SubmarinePing1.svg", "sound/OldFashioned/SubmarinePing1.wav" ),
      new SoundEffect( "TickTock1", "Tick Tock", "img/OldFashioned/TickTock1.svg", "sound/OldFashioned/TickTock1.wav" ),
      ...
      new SoundEffect( "TypewriterBell1", "Typewriter Bell", "img/OldFashioned/TypewriterBell1.svg", "sound/OldFashioned/TypewriterBell1.wav" ),
...
myApp.onPageInit('animals', function (page) {
    var animalSounds = [
      ...
      new SoundEffect( "Cat1", "Cat", "img/Animals/Cat1.svg", "sound/Animals/Cat1.wav" ),
      new SoundEffect( "Cow1", "Cow", "img/Animals/Cow1.svg", "sound/Animals/Cow1.wav" ),
      ...
      new SoundEffect( "Crow1", "Crow", "img/Animals/Crow1.svg", "sound/Animals/Crow1.wav" ),
      new SoundEffect( "DogBarks1", "Dog Barks", "img/Animals/DogBarks1.svg", "sound/Animals/DogBarks1.mp3" ),
      new SoundEffect( "Ducks1", "Ducks", "img/Animals/Ducks1.svg", "sound/Animals/Ducks1.wav" ),
      ...
      new SoundEffect( "Kitten1", "Kitten 1", "img/Animals/Kitten1.svg", "sound/Animals/Kitten1.wav" ),
      ...
      new SoundEffect( "MouseSqueak1", "Mouse Squeak", "img/Animals/MouseSqueak1.svg", "sound/Animals/MouseSqueak1.wav" ),
      new SoundEffect( "PigGrunt1", "Pig Grunt", "img/Animals/PigGrunt1.svg", "sound/Animals/PigGrunt1.wav" ),
      new SoundEffect( "PigSnort1", "Pig Snort", "img/Animals/PigSnort1.svg", "sound/Animals/PigSnort1.wav" ),
      new SoundEffect( "Rooster1", "Rooster", "img/Animals/Rooster1.svg", "sound/Animals/Rooster1.wav" ),
      new SoundEffect( "Sheep1", "Sheep", "img/Animals/Sheep1.svg", "sound/Animals/Sheep1.mp3" ),
      new SoundEffect( "Turkey1", "Turkey", "img/Animals/Turkey1.svg", "sound/Animals/Turkey1.wav" ),
      new SoundEffect( "Whales1", "Whales", "img/Animals/Whales1.svg", "sound/Animals/Whales1.wav" ),
      new SoundEffect( "Wolf1", "Wolf", "img/Animals/Wolf1.svg", "sound/Animals/Wolf1.wav" )
    ];
...
myApp.onPageInit('fairy', function(page) {
    var fairyTaleSounds = [
      ...
      new SoundEffect( "CastSpell1", "Cast Spell 1", "img/FairyTale/CastSpell1.svg", "sound/FairyTale/CastSpell1.wav" ),
      new SoundEffect( "CastSpell2", "Cast Spell 2", "img/FairyTale/CastSpell2.svg", "sound/FairyTale/CastSpell2.wav" ),
      ...
      new SoundEffect( "FireCrackling1", "Fire Crackling", "img/FairyTale/FireCrackling1.svg", "sound/FairyTale/FireCrackling1.wav" ),
      ...
      new SoundEffect( "MagicTwinkle1", "Magic Twinkle", "img/FairyTale/MagicTwinkle1.svg", "sound/FairyTale/MagicTwinkle1.wav" ),
      new SoundEffect( "OrchestralString1", "Orchestral String", "img/FairyTale/OrchestralString1.svg", "sound/FairyTale/OrchestralString1.wav" ),
      new SoundEffect( "River1", "River", "img/FairyTale/River1.svg", "sound/FairyTale/River1.mp3" ),
      new SoundEffect( "Rooster1", "Rooster", "img/FairyTale/Rooster1.svg", "sound/FairyTale/Rooster1.wav" ),
      new SoundEffect( "SwordFight1", "Sword Fight", "img/FairyTale/SwordFight1.svg", "sound/FairyTale/SwordFight1.mp3" ),
      new SoundEffect( "WitchCackle1", "Witch Cackle 1", "img/FairyTale/WitchCackle1.svg", "sound/FairyTale/WitchCackle1.wav" ),
...
myApp.onPageInit('index', function(page) {
    var mainSounds = [
      ...
      new SoundEffect( "Applause1", "Applause", "img/Main/Applause1.svg", "sound/Main/Applause1.wav" ),
      ...
      new SoundEffect( "BoatHorn1", "Boat Horn 1", "img/Main/BoatHorn1.svg", "sound/Main/BoatHorn1.wav" ),
      ...
      new SoundEffect( "Cat1", "Cat", "img/Main/Cat1.svg", "sound/Main/Cat1.wav" ),
      ...
      new SoundEffect( "Doorbell1", "Doorbell", "img/Main/Doorbell1.svg", "sound/Main/Doorbell1.wav" ),
      new SoundEffect( "EvilLaugh1", "Evil Laugh", "img/Main/EvilLaugh1.svg", "sound/Main/EvilLaugh1.flac" ),
      new SoundEffect( "Fail1", "Fail", "img/Main/Fail1.svg", "sound/Main/Fail1.mp3" ),
      new SoundEffect( "MagicTwinkle1", "Magic Twinkle", "img/Main/MagicTwinkle1.svg", "sound/Main/MagicTwinkle1.wav" ),
      new SoundEffect( "PhoneRinging1", "Phone Ringing", "img/Main/PhoneRinging1.svg", "sound/Main/PhoneRinging1.wav" ),
      new SoundEffect( "PoliceSiren1", "Police Siren", "img/Main/PoliceSiren1.svg", "sound/Main/PoliceSiren1.wav" ),
      new SoundEffect( "Success1", "Success", "img/Main/Success1.svg", "sound/Main/Success1.wav" ),
      new SoundEffect( "SuccessTaDa1", "Success Ta Da", "img/Main/SuccessTaDa1.svg", "sound/Main/SuccessTaDa1.flac" ),
      new SoundEffect( "Suspense1", "Suspense", "img/Main/Suspense1.svg", "sound/Main/Suspense1.wav" ),
      new SoundEffect( "Thunder1", "Thunder", "img/Main/Thunder1.svg", "sound/Main/Thunder1.flac" ),
      new SoundEffect( "TrainWhistle1", "Train Whistle", "img/Main/TrainWhistle1.svg", "sound/Main/TrainWhistle1.wav" ),
